...
class _FullMonitoringPageState extends State<FullMonitoringPage> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    switch (state) {
      case AppLifecycleState.resumed:
        ...
        if (mounted) {
          debugPrint('App resumed - forcing landscape mode for full monitoring');
          SystemChrome.setPreferredOrientations([
            DeviceOrientation.landscapeLeft,
            DeviceOrientation.landscapeRight,
          ]);
      ...
      case AppLifecycleState.detached:
        ...
        debugPrint('App paused/inactive - keeping landscape mode');
        break;
        
      case AppLifecycleState.hidden:
        // App is hidden but not destroyed
        debugPrint('App hidden - keeping landscape mode');
        break;
    }
  }
  ...
  void _restoreUserPreferredOrientations() {
    debugPrint('Restoring flexible orientations...');
    ...
    Future.delayed(const Duration(milliseconds: 200), () {
      if (mounted) {
        debugPrint('Successfully restored to flexible orientations');
      }
    });
  }
  ...
  Widget _buildZonesGrid(FireAlarmData fireAlarmData) {
    ...
    debugPrint('=== ZONES LAYOUT DEBUG (Column of Rows) ===');
    debugPrint('Total Zones: $totalZones');
    debugPrint('===========================================');
  ...
  Widget _buildStatusColumn(String label, String statusKey, FireAlarmData fireAlarmData) {
    ...
    // Enhanced trouble detection - check if there are any trouble zones
